// pages/logs/set/croppor/croppor.js
...
function cut () {
  ...
  self.setBoundStyle = function (ref) {
    ...
    // self.ctx.fill();
    // console.log(x, y, width, height, boundWidth, boundHeight)
    self.ctx.beginPath();
    self.ctx.setFillStyle(mask);
    self.ctx.lineTo(0, 0)
    self.ctx.lineTo(x + width/2, 0)
    self.ctx.lineTo(x + width / 2, y)
    self.ctx.arc(x + width / 2, y + height / 2, width / 2, Math.PI * 1.5, Math.PI * 1,true);
    self.ctx.lineTo(x, y + height / 2)
    self.ctx.lineTo(0, y + height / 2)
    self.ctx.fill();

    self.ctx.beginPath();
    self.ctx.setFillStyle(mask);
    self.ctx.lineTo(x + width / 2, 0)
    self.ctx.lineTo(x + boundWidth, 0)
    self.ctx.lineTo(x + boundWidth, y + height / 2)
    self.ctx.lineTo(x + width, y + height / 2)
    self.ctx.arc(x + width / 2, y + height / 2, width / 2, 0, Math.PI * 1.5, true);
    self.ctx.lineTo(x + width/2, y)
    self.ctx.fill();
    ...
    self.ctx.lineTo(x + boundWidth, y + height / 2)
    self.ctx.lineTo(x + width, y + height / 2)
    self.ctx.arc(x + width / 2, y + height / 2, width / 2, 0, Math.PI * 0.5, false);
    self.ctx.lineTo(x + width / 2, y + height)
    self.ctx.lineTo(x + width / 2, y + boundHeight)
    self.ctx.lineTo(x + boundWidth, y + boundHeight)
    self.ctx.fill();
    ...
    self.ctx.lineTo(x + width / 2, y + height)
    self.ctx.lineTo(x + width / 2, y + boundHeight)
    self.ctx.lineTo(0, y + boundHeight)
    self.ctx.lineTo(0, y + height / 2)
    self.ctx.lineTo(x, y + height / 2)
    self.ctx.arc(x + width / 2, y + height / 2, width / 2, Math.PI * 1, Math.PI * 0.5, true);
    self.ctx.fill();
